                ...
                <div class="card py-5 px-5">
                    <div class="card-body">
                        ...
                        <form role="form" class="form-horizontal p-t-20" id="bankForm" method="POST"
                              action="{{route('trades.sell.store',$offer->id)}}"
                            ...
                            <div class="form-group row">
                                <label for="charge" class="col-sm-3 control-label">You will charge</label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-sticky-note"></i></div>
...
@push('js')
    ...
    <script>
        ...
        const fee = {{setting('trade_fee')}};
        const rate = {{$offer->rate}};
        amount.addEventListener('input',function(e){
            const escrowFee = (e.target.value / 100) * fee;
            const mainCharge = (e.target.value * rate) + escrowFee;
            charge.value = mainCharge.toFixed(2);
        });
    </script>
@endpush
