...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Receive LTC</h3> </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Receive LTC</li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card py-5 px-5">
                    <div class="card-body">
                        <h4 class="card-title">Receive LTC</h4>
                        <h5>Scan The Qrcode to get your Deposit Address</h5>
                        <div class="d-flex justify-content-center">
                            <div>
                                {!! QrCode::size(240)->generate('litecoin:'.$address) !!}
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
