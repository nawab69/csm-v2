...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">TRANSFER BTC TO TRADE WALLET</h3> </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">TRANSFER BTC TO TRADE WALLET</li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card py-5 px-5">
                    <div class="card-body">
                        <h4 class="card-title">TRANSFER BTC TO TRADE WALLET</h4>
                        <h6 class="card-subtitle">Send Bitcoin from your Main BTC wallet to Trade Wallet</h6>
                        <form class="form-horizontal p-t-20" method="post" action="{{route('transfer.btc.check')}}">
                            @csrf
