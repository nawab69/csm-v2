        ...
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <div class="d-inline-block dropdown">
                    <a href="{{ route('app.giftcard.sell.create') }}" class="btn-shadow btn btn-info">
                        ...
                        <tbody>
                            @foreach($cards as $key=>$card)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-secondary btn-sm" href="{{ route('app.giftcard.sell.show',$card->id) }}"><i
                                                class="fas fa-eye"></i>
                                            <span>Show</span>
                                        </a>
                                        <a class="btn btn-info btn-sm" href="{{ route('app.giftcard.sell.edit',$card->id) }}"><i
                                                class="fas fa-edit"></i>
                                            <span>Edit</span>
                                        </a>
                                        ...
                                        <form id="delete-form-{{ $card->id }}"
                                              action="{{ route('app.giftcard.sell.destroy',$card->id) }}" method="POST"
                                              style="display: none;">
                                            @csrf()
                                            @method('DELETE')
                                        </form>
