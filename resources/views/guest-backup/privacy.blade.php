                    ...
                    <div class="col-md-12">
                        <div class="breadcrumbs">
                            <ul>
                                ...
                                <li><a href="about-v2.html">Privacy Policy</a></li>
                            </ul>
                        </div><!-- /.breadcrumbs -->
                    </div><!-- /.col-md-12 -->
                </div><!-- /.row -->
                    ...
                    <div class="col-md-12">
                        <div class="wrap-wallet">
                            <div class="content-box margin_bottom_79">
                                ...
                                <p class="margin_bottom_35">Bitcoin is a new currency that was created in 2009 by an unknown person using the alias Satoshi Nakamoto. Transactions are made with no middle men – meaning, no banks! Bitcoin can be used to book hotels on Expedia, shop for furniture on Overstock and buy Xbox games. But much of the hype is about get- <br >ting rich by trading it. The price of bitcoin skyrocketed into the thousands in 2017.</p>
