...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Edit Offer</h3> </div>
                    ...
                    <div class="card-body">
                        ...
                        <form role="form" class="form-horizontal p-t-20" id="bankForm" method="POST"
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <select id="type" name="type" class="form-control">
                                            <option value="buy" @if($offer->type=='buy') selected @endif >BUY</option>
                                            <option value="sell" @if($offer->type=='sell') selected @endif >SELL</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-9">
                                    <div class="form-group">
                                        ...
                                        <select id="currency" name="currency" class="form-control">
                                            ...
                                            <option value="{{$currency->id}}" @if($offer->currency->id==$currency->id) selected @endif>{{$currency->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="method" name="method" class="form-control">
                                            @foreach($methods as $method)
                                                <option value="{{$method->id}}" @if($offer->method->id==$method->id) selected @endif>{{$method->name}} - {{$method->type}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <textarea type="text" rows="2" style="height: 100%" class="form-control" id="extra_info" name="extra_info" placeholder="Description">{{$offer->extra_info ?? ''}}</textarea>
                                    </div>
                                </div>
                            </div>
