        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card py-5 px-5">
                    <div class="card-body">
                        <h4 class="card-title">Send LTC</h4>
                        <h6 class="card-subtitle">Send Bitcoin from your LTC wallet to any ltc address</h6>

                        <form class="form-horizontal p-t-20" method="post" action="{{route('ltc.send.now')}}">
                            @csrf
                            ...
                            <div id="status" style="display: none">
                                <div class="row" >
                                    ...
                                    <div class="col-sm-9">
                                        <span id="fee"></span> <span> LTC</span>
                                    </div>
                                </div>
                                <div class="row mt-3 mb-3">
                                    <div class="col-sm-3">Estimate Total</div>
                                    <div class="col-sm-9">
                                        <span id="total"></span> <span> LTC</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row m-b-0" id="calculate">
                                <div class="offset-sm-3 col-sm-9">
                                    <button onclick="calculateFee('ltc')" class="btn btn-dark waves-effect waves-light">Calculate Fee</button>
                                    <button onclick="calculateMax('ltc')" class="btn btn-dark waves-effect waves-light">Max</button>
                                </div>
                            </div>
                            ...
                            <table class="table table-de mb-0">
                                ...
                                @foreach($transactions as $key=>$trx)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://sochain.com/tx/LTC/{{$trx->txid}}" class="btn btn-sm round btn-outline-info"> Details </a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
