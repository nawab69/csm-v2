        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card py-5 px-5">
                    <div class="card-body">
                        <h4 class="card-title">Send DOGE</h4>
                        <h6 class="card-subtitle">Send Bitcoin from your DOGE wallet to any doge address</h6>

                        <form class="form-horizontal p-t-20" method="post" action="{{route('doge.send.now')}}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="cc DOGE"></i></div>
                                    ...
                                    <h6 class="card-subtitle">Available Balance : {{$balance}} DOGE</h6>
                                </div>
                            </div>
                            <div id="status" style="display: none">
                                <div class="row" >
                                    ...
                                    <div class="col-sm-9">
                                        <span id="fee"></span> <span> DOGE</span>
                                    </div>
                                </div>
                                <div class="row mt-3 mb-3">
                                    <div class="col-sm-3">Estimate Total</div>
                                    <div class="col-sm-9">
                                        <span id="total"></span> <span> DOGE</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row m-b-0" id="calculate">
                                <div class="offset-sm-3 col-sm-9">
                                    <button onclick="calculateFee('doge')" class="btn btn-dark waves-effect waves-light">Calculate Fee</button>
                                    <button onclick="calculateMax('doge')" class="btn btn-dark waves-effect waves-light">Max</button>
                                </div>
                            </div>
                            ...
                            <table class="table table-de mb-0">
                                ...
                                @foreach($transactions as $key=>$trx)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="https://sochain.com/tx/DOGE/{{$trx->txid}}" class="btn btn-sm round btn-outline-info"> Details </a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
