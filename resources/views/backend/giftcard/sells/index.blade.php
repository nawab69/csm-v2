...
@section('title','Giftcard Sell Orders')
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>{{ __('All Giftcard Sell Orders') }}</div>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <tbody>
                            @foreach($orders as $key=>$deposit)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $deposit->giftcard->name }}</td>
                                    <td class="text-center">{{ $deposit->amount.' '.$deposit->currency }}</td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-secondary btn-sm" href="{{ route('app.giftcard.sells.show',$deposit->id) }}"><i
                                                class="fas fa-eye"></i>
                                            <span>Show</span>
                                        </a>
                                    </td>
