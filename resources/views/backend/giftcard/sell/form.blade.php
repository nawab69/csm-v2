    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>{{ __((isset($sell) ? 'Edit' : 'Create New') . ' Card') }}</div>
            </div>
            <div class="page-title-actions">
                <div class="d-inline-block dropdown">
                    <a href="{{ route('app.giftcard.sell.index') }}" class="btn-shadow btn btn-danger">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form role="form" id="cardFrom" method="POST"
                  action="{{ isset($sell) ? route('app.giftcard.sell.update',$sell->id) : route('app.giftcard.sell.store') }}"
