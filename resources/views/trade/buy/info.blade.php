                        ...
                        @if($trade->status == 'paid')
                                <div class="card">
                                    <span class="alert alert-info">
                                        You have marked the Trade as paid! Waiting for seller's response .....
                                    </span>
                                    <div class="d-flex justify-content-around">
                                        <a href="#" onclick="cancelTrade()" class="btn btn-success">Cancel Anyway</a>
                        ...
                        @if($trade->status == 'waiting')
                            <div class="card">
                                    <span class="alert alert-warning">
                                        You didn't paid yet. After payment done click mark as paid.
                                    </span>
                                <div class="d-flex justify-content-around">
                                    <a href="#" onclick="cancelTrade()" class="btn btn-warning">Cancel</a>
                                    <a href="#" onclick="paidTrade()" class="btn btn-info">Mark as Paid</a>
                                    ...
                                    <form id="paid-trade" action="{{route('trades.sell.update',$trade->trx_id)}}" method="post">
                                        @csrf
                                        <input type="text" hidden name="status" value="paid">
                                    </form>
