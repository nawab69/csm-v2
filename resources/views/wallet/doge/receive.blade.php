...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Receive DOGE</h3> </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Receive DOGE</li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card py-5 px-5">
                    <div class="card-body">
                        <h4 class="card-title">Receive DOGE</h4>
                        <h5>Scan The Qrcode to get your Deposit Address</h5>
                        <div class="d-flex justify-content-center">
                            <div>
                                {!! QrCode::size(240)->generate('dogecoin:'.$address) !!}
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
                            ...
                            <table class="table table-de mb-0">
                                ...
                                @foreach($transactions as $key=>$trx)
                                    <tr>
                                        ...
                                        <td>{{$trx->txid}}</td>
                                        <td>{{$trx->senders[0]}}</td>
                                        <td>{{$trx->amounts_received[0]->amount}}</td>
