                ...
                <div class="table-responsive">
                    <table id="datatable" class="align-middle mb-0 table table-borderless table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <th class="text-center">Deposit At</th>
                        ...
                        <tbody>
                            @foreach($deposits as $key=>$deposit)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $deposit->amount.' '.$deposit->currency->display }}</td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-secondary btn-sm" href="{{ route('app.deposits.show',$deposit->trx_id) }}"><i
                                                class="fas fa-eye"></i>
                                            <span>Show</span>
                                        </a>
                                    </td>
