                        ...
                        <tbody>
                            @foreach($withdraws as $key=>$withdraw)
                                <tr>
                                    ...
                                    <td class="text-center">{{ $withdraw->trx_id }}</td>
                                    <td class="text-center">{{ $withdraw->user->email }}</td>
                                    <td class="text-center">{{ $withdraw->user->username }}</td>
                                    <td class="text-center">{{ $withdraw->amount.' '.$withdraw->currency->display }}</td>
                                    <td class="text-center">{{ $withdraw->fee.' '.$withdraw->currency->display }}</td>
                                    <td class="text-center">{{ $withdraw->total.' '.$withdraw->currency->display }}</td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-secondary btn-sm" href="{{ route('app.withdraws.show',$withdraw->id) }}"><i
                                                class="fas fa-eye"></i>
                                            <span>Show</span>
                                        </a>
                                    </td>
