...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Receive Fiat Currency</h3> </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Receive Fiat Currency</li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card py-5 px-5">
                    <div class="card-body">
                        <h4 class="card-title">Receive Fiat</h4>
                            ...
                            <table class="table table-de mb-0">
                                ...
                                @foreach($receives as $key=>$trx)
                                    <tr>
                                        ...
                                        <td><span class="badge badge-success">{{$trx->currency->name}}</span></td>
                                        <td>{{$trx->amount}} {{$trx->currency->display}}</td>
                                        <td>{{$trx->note}}</td>
