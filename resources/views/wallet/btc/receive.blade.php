...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Receive BTC</h3> </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                <li class="breadcrumb-item active">Receive BTC</li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="card py-5 px-5">
                    <div class="card-body">
                        <h4 class="card-title">Receive BTC</h4>
                        <h5>Scan The Qrcode to get your Deposit Address</h5>
                        <div class="d-flex justify-content-center">
                            <div>
                                {!! QrCode::size(240)->generate('bitcoin:'.$address) !!}
                            </div>
                        </div>
                        <div class="d-flex justify-content-center">
