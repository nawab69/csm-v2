...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Buy Gift card</h3> </div>
            ...
            <div class="col-lg-8">
                <div class="card py-5 px-5">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle">Buy Giftcard from your Usd / Naira Wallet</h6>
                        <!-- form start -->
                        <form role="form" class="form-horizontal p-t-20" id="bankForm" method="POST"
                              action="{{route('user.giftcard.buyNow')}}"
                            ...
                            <div class="form-group row">
                                <label for="get_amount" class="col-sm-3 control-label">Charge Amount</label>
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <div class="input-group-addon"><i class="fa fa-coins"></i></div>
